...
function runProcess(processName, input) {
    ...
    return (0, _Process.fetchProcessInjections)(_config2.default.appName, processName, input).then(function (_ref) {
        ...
        return (0, _Process.renderProcess)(processName, input, injections);
    }, function (err) {
        return _react2.default.createElement(_Process.ErrorView, { title: "Error running Process", info: err });
    }).then(function (elem) {
